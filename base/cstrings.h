...
error
cstring__copy  (char **target,
                u32 source_length,
                char *source,
                struct allocator *allocator);

void    cstring__replace(s32 length, char *target, char old_char, char new_char);
error   cstring__get_first_index(u64 *index, char *haystack, char needle);
error   cstring__get_last_index(u64 *index, char *haystack, char needle);
